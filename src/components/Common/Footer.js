...
const Footer = () => (
  ...
  <div className='container-four'>
    ...
    <div className='contact-text'>
      <p>I am currently looking for a junior developer position and I'm always happy to chat. <br/> Hobbies include: Coding, Brazilian jiu-jitsu, Rugby, Oil painting, Photography, Philosophy </p>
