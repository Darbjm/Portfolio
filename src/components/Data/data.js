const projectsData = [
  ...
  },
  {
    ...
    image: 'word',
    logo: 'ee',
    text: 'I was approached by two friends with an idea to create a tool for brands. It allows brands to brief freelance copywriters, clearly and efficiently. The a brand may upload their guidelines, photos, and other documents to help the copywriter selected to write for them. It has been trialed with TRIP drinks.',
    time: '3 months',
    title: 'Wordee',
    skills: ['React.js with Hooks', 'Express.js', 'JavaScript', 'Bulma', 'JSON', 'HTML', 'SASS'],
    team: 'Solo project',
  ...
  },
  {
    ...
    image: 'Jour',
    logo: 'no',
    text: 'A two model RESTful API using a Django back end and a React front end. Journo is a travel diary with open entries so other users may see your trips and become inspired. I recreated the Mapbox from ChowVow with Hooks. The user is able to add images via Cloudinary and the forms will warm the user of any mistakes while registering.',
    time: '7 days',
    title: 'Journo',
    skills: ['React.js with Hooks', 'Django', 'PostgreSQL', 'Python', 'JavaScript', 'Bulma', 'JSON', 'HTML', 'SASS'],
    team: 'Solo project',
    app: 'https://journo-ga.herokuapp.com/',
    github: 'https://github.com/Darbjm/Journo'
  },
  {
    ...
    time: '7 days',
    title: 'ChowVow',
    skills: ['React.js', 'Express.js', 'Bulma', 'JavaScript', 'JSON', 'HTML', 'SASS'],
    team: 'Team of four',
  ...
  },
  {
    ...
    image: 'draw',
    logo: 'connect',
    text: 'I developed a cowboy themed connect 4 game. You can play with a friend or against a tricky AI I built. Oh and don\'t forget to turn on the sound effects.',
    time: '10 days',
    title: 'Connect draw',
  ...
  },
  {
    ...
    image: 'D3',
    logo: 'twilio',
    text: 'Two small projects. One using Twilio and Yandex a user can send a message via SMS in any language. The other was creating graphs using D3 in React, this was interesting as both react and D3 try to manipulate the DOM.',
    time: '4 days',
    title: 'Collection of small projects',
    skills: ['Twilio', 'Yandex', 'Express.js', 'React.js', 'D3', 'HTML', 'SASS', 'Bulma', 'Bootstrap'],
    team: 'Solo project',
