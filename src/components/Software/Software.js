          ...
          <section id='statement' className='statement'>
            <div className='container-one'>
              <div className='text'>
                ...
                <br /> <br />I am very interested in building resilient products built with<strong className='primary'> microservices.</strong> From my knowledge in design I see these having the most potential in terms of <strong className='primary'>flexibility and creativity.</strong>
                </div>
              </div>
