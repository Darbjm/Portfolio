...
const projects = [
  {
    ...
    text: ['Crypt cell was a project that evolved from research I was doing into Sarah Golds\' Alternet and death online. There is a small nod to the concept of death online in that the router will store your information when you die like a digital urn, there is an option to donate your data like donating organs.', 'The main part of the project was an attempt to disintermediate consumers of data with producers of data, this was done through the user being able to choose who bought their data on the app based market-place, therefore people begin to regain control of their data. This worked by taking advantage of current laws that make it inefficient and costly for companies like Google to sell your data, whereas if you were to sell your own data it would be faster, less costly and more accurate.', 'It worked using a delocalized cloud, each users VPN router would store information, then using blockchain it could be securely and accurately sold. The concept is similar to Wibson\'s decentralized blockchain platform however to my knowledge Crypt cell was the first to look at this problem.', 'After university I continued work on Crypt cell, changing its name to DataFair and working with two individuals who were in the data industry. Regretfully we had to drop the project due to funding and other constraints.'],
    photos: crypt,
    fade: 'fade-right'
  },
  {
