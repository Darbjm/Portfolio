      ...
      <section className='border'>
        <div className='history'>
          <div className='history-card'>
            ...
            The Client projects and Websites were produced while I was part of a small team at <strong className='primary'>Alter Agency</strong> I worked as the <strong className='primary'>In-House Photographer</strong> and a <strong className='primary'>Graphic and Web Designer. </strong>
            We won clients such as Nike and Bombay Sapphire and continued work with Bacardi, Havaianas, JD Sports, King's Ginger and Alcatel.
            I gained an understanding of <strong className='primary'>project management, production, and presentation.</strong><br/><br/>
            ...
            It was here I produced my self-initiated projects and received my <strong className='primary'>award from the design museum,</strong> acquired Design Thinking as a skill and gained an understanding of innovation.
