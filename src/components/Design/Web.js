...
const Website = () => (
  <section className="website">
    ...
    <div className="center">
      <h4>
        Using wordpress I worked with another freelancer to build and maintain
        these websites
      </h4>
      <div className="grey"></div>
      <p>
        Whilst working on these sites I aquired:
        <br /> 1. SEO strategies
        <br /> 2. A strong understanding of website structure and layout
        <br /> 3. An insight into servers and urls
      </p>
    </div>
